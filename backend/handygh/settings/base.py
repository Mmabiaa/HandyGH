"""
Django base settings for HandyGH project.
...
- Modular app structure in apps/ directory for better organization
- REST Framework with JWT authentication for stateless API
- Comprehensive security settings following Django best practices
"""
...
WSGI_APPLICATION = "handygh.wsgi.application"
...
LANGUAGE_CODE = "en-gh"  # Ghana English
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "anon": "100/hour",
        "user": "1000/hour",
        "otp_request": config("RATE_LIMIT_OTP_REQUEST", default="5/hour"),
        "otp_verify": config("RATE_LIMIT_OTP_VERIFY", default="10/hour"),
    },
...
DEFAULT_COMMISSION_RATE = config("DEFAULT_COMMISSION_RATE", default=0.10, cast=float)
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": BASE_DIR / "logs" / "handygh.log",
...
# CORS Configuration (will be overridden in environment-specific settings)
