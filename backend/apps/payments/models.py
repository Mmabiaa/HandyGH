...
class Transaction(models.Model):
    ...
    currency = models.CharField(max_length=3, default="GHS", help_text="Currency code (ISO 4217)")

    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default="PENDING", help_text="Transaction status"
    )

    txn_provider = models.CharField(
        max_length=20, choices=PROVIDER_CHOICES, help_text="Payment provider"
    )

    txn_provider_ref = models.CharField(
        max_length=255, blank=True, help_text="External transaction reference from payment provider"
    )
...
class Commission(models.Model):
    ...
    name = models.CharField(max_length=255, help_text="Commission configuration name")
    ...
    category = models.CharField(
        max_length=100, blank=True, help_text="Service category (if applies_to is CATEGORY)"
    )
