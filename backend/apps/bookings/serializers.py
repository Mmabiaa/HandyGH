...
from core.validators import validate_booking_duration, validate_future_datetime
...
class BookingCreateSerializer(serializers.Serializer):
    ...
    provider_service_id = serializers.UUIDField(
        required=True, help_text="UUID of the provider service to book"
    )
    ...
    address = serializers.CharField(
        required=True, max_length=500, help_text="Service location address"
    )
