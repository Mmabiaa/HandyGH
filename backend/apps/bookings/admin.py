...
class BookingAdmin(admin.ModelAdmin):
    ...
    list_filter = ["status", "payment_status", "created_at", "scheduled_start"]
    ...
    fieldsets = (
        ("Booking Information", {"fields": ("id", "booking_ref", "status", "payment_status")}),
        ("Parties", {"fields": ("customer", "provider", "provider_service")}),
        ("Schedule", {"fields": ("scheduled_start", "scheduled_end", "address", "notes")}),
        ("Financial", {"fields": ("total_amount", "commission_amount")}),
    ...
    def get_queryset(self, request):
        ...
        return qs.select_related("customer", "provider", "provider__user", "provider_service")
...
class BookingStatusHistoryAdmin(admin.ModelAdmin):
    ...
    search_fields = ["booking__booking_ref", "reason"]
