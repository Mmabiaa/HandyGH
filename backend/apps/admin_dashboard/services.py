...
class AdminReportService:
    ...
    def get_booking_statistics(
        ...
        return {
            ...
            'total_amount': str(booking_amounts['total_amount'] or Decimal('0.00')),
            'avg_amount': str(booking_amounts['avg_amount'] or Decimal('0.00')),
            'total_commission': str(booking_amounts['total_commission'] or Decimal('0.00')),
