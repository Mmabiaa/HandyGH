...
from core.permissions import IsAdmin, IsOwnerOrAdmin, IsProvider
...
from .services import ProviderSearchService, ProviderService, ServiceManagementService
...
class ServiceCategoryViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={200: ServiceCategorySerializer, 404: "Not Found"},
    )
    def retrieve(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"success": False, "errors": {"message": "Category not found"}, "meta": {}},
...
class ProviderViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={200: ProviderSearchResultSerializer(many=True), 400: "Bad Request"},
    )
    def list(self, request):
        """
    ...
    @swagger_auto_schema(
        ...
        responses={200: ProviderDetailSerializer, 404: "Not Found"},
    )
    def retrieve(self, request, pk=None):
        """
    ...
    def partial_update(self, request, pk=None):
        ...
        try:
            ...
            if request.user != provider.user and not request.user.role == "ADMIN":
                return Response(
                    {"success": False, "errors": {"message": "Permission denied"}, "meta": {}},
            ...
            provider = ProviderService.update_provider(pk, **serializer.validated_data)
    ...
    def add_service(self, request, pk=None):
        ...
        try:
            ...
            service = ServiceManagementService.add_service(
                provider_id=pk, **serializer.validated_data
            )
    ...
    @swagger_auto_schema(
        ...
        responses={200: ProviderServiceSerializer(many=True), 404: "Not Found"},
    )
    ...
    def list_services(self, request, pk=None):
        ...
        try:
            ...
            services = ServiceManagementService.get_provider_services(
                provider_id=pk, active_only=active_only
            )
            ...
            return Response(
                {
                    "success": True,
                    "data": serializer.data,
                    "meta": {"count": services.count(), "active_only": active_only},
                }
            )
...
class ProviderServiceViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={200: ProviderServiceSerializer, 404: "Not Found"},
    )
    def retrieve(self, request, pk=None):
    ...
    def partial_update(self, request, pk=None):
        ...
        try:
            ...
            serializer = ProviderServiceCreateSerializer(service, data=request.data, partial=True)
            serializer.is_valid(raise_exception=True)

            service = ServiceManagementService.update_service(pk, **serializer.validated_data)
    ...
    @swagger_auto_schema(
        ...
        responses={200: ProviderServiceSerializer, 403: "Forbidden", 404: "Not Found"},
    )
