...
class ServiceCategory(models.Model):
    ...
    icon = models.CharField(
        max_length=100,
        blank=True,
        help_text='Icon identifier or URL'
    )
...
class Provider(models.Model):
    ...
    categories = models.JSONField(
        default=list,
        help_text='List of service category slugs'
    )
    ...
    verified = models.BooleanField(
        default=False,
        help_text='Whether provider has been verified'
    )
    
    verification_doc_url = models.URLField(
        blank=True,
        help_text='URL to verification document (ID, license, etc.)'
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text='Whether provider is accepting bookings'
    )
...
class ProviderService(models.Model):
    ...
    title = models.CharField(
        max_length=255,
        help_text='Service title (e.g., "Emergency Plumbing Repair")'
    )
