...
class ProviderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['id', 'rating_avg', 'rating_count', 'response_time_avg', 'created_at', 'updated_at']
    inlines = [ProviderServiceInline]
    
    fieldsets = (
        ('Basic Information', {
            'fields': ('id', 'user', 'business_name', 'categories')
        }),
        ('Location', {
            'fields': ('latitude', 'longitude', 'address')
        }),
        ('Verification', {
            'fields': ('verified', 'verification_doc_url')
        }),
        ('Ratings & Performance', {
            'fields': ('rating_avg', 'rating_count', 'response_time_avg')
        }),
        ('Status', {
            'fields': ('is_active',)
        }),
...
class ProviderServiceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Pricing', {
            'fields': ('price_type', 'price_amount', 'duration_estimate_min')
        }),
        ('Status', {
            'fields': ('is_active',)
        }),
