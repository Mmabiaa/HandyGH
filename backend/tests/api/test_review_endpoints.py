...
class TestCreateReviewEndpoint:
    ...
    def test_create_review_success(self, api_client, customer, customer_token, booking):
        ...
        data = {"rating": 5, "comment": "Excellent service! Very professional."}
...
class TestProviderReviewsListEndpoint:
    ...
    def test_list_provider_reviews(self, api_client, customer, customer_token, provider, booking):
        ...
        Review.objects.create(
            booking=booking, customer=customer, provider=provider, rating=5, comment="Great service"
        )
        ...
        Review.objects.create(
            booking=booking2, customer=customer, provider=provider, rating=4, comment="Good service"
        )
    ...
    def test_list_provider_reviews_pagination(
        self, api_client, customer, customer_token, provider, booking
    ):
...
class TestReviewDetailEndpoint:
    ...
    def test_get_review_detail_unauthenticated(self, api_client, customer, provider, booking):
        ...
        review = Review.objects.create(
            booking=booking, customer=customer, provider=provider, rating=5, comment="Test"
        )
