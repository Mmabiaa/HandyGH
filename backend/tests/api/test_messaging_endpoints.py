...
class TestBookingMessagesEndpoint:
    ...
    def test_send_message_not_participant(self, api_client, customer_user, customer_user_token, booking):
    ...
    def test_send_message_invalid_attachment_url(self, api_client, customer, customer_token, booking):
    ...
    def test_get_messages_success(self, api_client, customer, customer_token, provider_user, booking):
    ...
    def test_get_messages_invalid_pagination_params(self, api_client, customer, customer_token, booking):
    ...
    def test_get_messages_not_participant(self, api_client, customer_user, customer_user_token, booking):
    ...
    def test_provider_can_send_and_receive_messages(self, api_client, provider_user, provider_token, customer, booking):
