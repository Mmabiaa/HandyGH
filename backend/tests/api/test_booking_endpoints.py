...
class TestBookingEndpoints:
    ...
    def test_create_booking_success(self, api_client, customer_token, customer, provider_service):
    ...
    def test_list_bookings_customer(self, api_client, customer_token, booking):
    ...
    def test_list_bookings_provider(self, api_client, provider_token, booking):
    ...
    def test_list_bookings_filter_by_status(self, api_client, customer_token, booking):
    ...
    def test_retrieve_booking(self, api_client, customer_token, booking):
    ...
    def test_accept_booking_success(self, api_client, provider_token, booking):
    ...
    def test_accept_booking_customer_cannot(self, api_client, customer_token, booking):
    ...
    def test_decline_booking_success(self, api_client, provider_token, booking):
        ...
        response = api_client.patch(f"/api/v1/bookings/{booking.id}/decline/", data, format="json")

        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "CANCELLED"

    def test_update_status_to_in_progress(self, api_client, provider_token, booking):
        ...
        data = {"status": "IN_PROGRESS", "reason": "Service started"}
        response = api_client.patch(f"/api/v1/bookings/{booking.id}/status/", data, format="json")

        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "IN_PROGRESS"

    def test_update_status_to_completed(self, api_client, provider_token, booking):
        ...
        data = {"status": "COMPLETED", "reason": "Service completed successfully"}
        response = api_client.patch(f"/api/v1/bookings/{booking.id}/status/", data, format="json")

        assert response.status_code == status.HTTP_200_OK
        assert response.data["status"] == "COMPLETED"

    def test_update_status_invalid_transition(self, api_client, provider_token, booking):
        ...
        data = {"status": "COMPLETED", "reason": "Invalid transition"}
        response = api_client.patch(f"/api/v1/bookings/{booking.id}/status/", data, format="json")

        assert response.status_code == status.HTTP_400_BAD_REQUEST

    def test_cancel_booking_by_customer(self, api_client, customer_token, booking):
        ...
        data = {"status": "CANCELLED", "reason": "Changed my mind"}
        response = api_client.patch(f"/api/v1/bookings/{booking.id}/status/", data, format="json")
