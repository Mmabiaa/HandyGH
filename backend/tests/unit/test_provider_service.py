...
class TestCreateProvider:
    ...
    def test_create_provider_multiple_categories(self, db, provider_user, plumbing_category, electrical_category):
    ...
    def test_create_provider_invalid_category(self, db, provider_user, plumbing_category):
        ...
        with pytest.raises(CustomValidationError) as exc_info:
            ProviderService.create_provider(
                user=provider_user,
                categories=['plumbing', 'invalid_category']
            )
...
class TestUpdateProvider:
    ...
    def test_update_provider_categories(self, db, provider_user, plumbing_category, electrical_category):
    ...
    def test_update_provider_ignores_protected_fields(self, db, provider_user):
        ...
        updated = ProviderService.update_provider(
            str(provider.id),
            verified=True,  # This should be ignored
            business_name='New Name'
        )
