...
class TestAdminReportService:
    ...
    def test_get_dashboard_stats_with_bookings(self, customer_user, provider, provider_service):
    ...
    def test_get_user_statistics_with_date_range(self, customer_user):
        ...
        stats = AdminReportService.get_user_statistics(start_date=start_date, end_date=end_date)
    ...
    def test_get_booking_statistics_with_date_range(self, booking):
        ...
        stats = AdminReportService.get_booking_statistics(start_date=start_date, end_date=end_date)
