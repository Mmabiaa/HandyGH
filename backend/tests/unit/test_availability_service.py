...
class TestAvailabilityService:
    ...
    def test_check_availability_no_conflicts(self, provider, provider_service):
        ...
        is_available = AvailabilityService.check_availability(
            provider_id=str(provider.id), start_time=start_time, end_time=end_time
        )

        assert is_available is True

    def test_check_availability_with_conflict(self, customer, provider, provider_service):
        ...
        is_available = AvailabilityService.check_availability(
            provider_id=str(provider.id), start_time=new_start, end_time=new_end
        )
    ...
    def test_check_availability_exclude_booking(self, customer, provider, provider_service):
