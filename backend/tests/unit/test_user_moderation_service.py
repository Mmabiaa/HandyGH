...
class TestUserModerationService:
    ...
    def test_suspend_user(self, customer_user):
        ...
        result = UserModerationService.suspend_user(
            user_id=str(customer_user.id), reason="Test suspension"
        )
    ...
    def test_suspend_nonexistent_user(self):
        ...
        with pytest.raises(User.DoesNotExist):
            UserModerationService.suspend_user(user_id=str(uuid.uuid4()), reason="Test suspension")
    ...
    def test_activate_user(self, customer_user):
        ...
        result = UserModerationService.activate_user(user_id=str(customer_user.id))
    ...
    def test_activate_nonexistent_user(self):
        ...
        with pytest.raises(User.DoesNotExist):
            UserModerationService.activate_user(user_id=str(uuid.uuid4()))
    ...
    def test_revoke_all_sessions(self, customer_user):
        ...
        result = UserModerationService.revoke_all_sessions(user_id=str(customer_user.id))
