...
def multiple_providers(db, service_category):
    ...
    user1 = User.objects.create(
        phone="+233241111111", email="provider1@example.com", name="Provider One", role="PROVIDER"
    )
    ...
    user2 = User.objects.create(
        phone="+233242222222", email="provider2@example.com", name="Provider Two", role="PROVIDER"
    )
    ...
    user3 = User.objects.create(
        phone="+233243333333", email="provider3@example.com", name="Provider Three", role="PROVIDER"
    )
...
class TestProviderSearch:
    ...
    def test_search_by_location_and_radius(self, multiple_providers):
        ...
        results = ProviderSearchService.search(
            latitude=Decimal("5.6037"), longitude=Decimal("-0.1870"), radius_km=3.0
        )
    ...
    def test_search_with_price_range(self, multiple_providers):
        ...
        results = ProviderSearchService.search(
            min_price=Decimal("75.00"), max_price=Decimal("150.00")
        )
...
class TestProviderSearchResults:
    ...
    def test_result_structure(self, provider_with_location):
        ...
        results = ProviderSearchService.search(
            latitude=Decimal("5.6037"), longitude=Decimal("-0.1870")
        )
...
class TestProviderSearchEdgeCases:
    ...
    def test_search_with_providers_without_location(self, provider_user, service_category):
        ...
        results = ProviderSearchService.search(
            latitude=Decimal("5.6037"), longitude=Decimal("-0.1870"), radius_km=10.0
        )
