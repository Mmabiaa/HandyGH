...
class TestUpdateService:
    ...
    def test_update_service_category(self, db, provider_with_profile, plumbing_category):
        ...
        updated = ServiceManagementService.update_service(
            str(service.id),
            category_id=str(electrical_category.id)
        )
    ...
    def test_update_service_inactive_category(self, db, provider_with_profile, plumbing_category, inactive_category):
