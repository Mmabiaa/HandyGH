...
from apps.disputes.services import DisputeService, DisputeResolutionService
...
class TestDisputeResolutionService:
    ...
    def test_resolve_dispute_success(self, admin_user, customer, booking):
        ...
        resolution_text = 'After reviewing the evidence, we have determined that a partial refund is appropriate.'
