...
class TestBookingService:
    ...
    def test_validate_booking_data_success(self, customer, provider_service):
    ...
    def test_validate_booking_data_non_customer_fails(self, provider_user, provider_service):
    ...
    def test_validate_booking_data_inactive_service_fails(self, customer, provider_service):
    ...
    def test_validate_booking_data_past_time_fails(self, customer, provider_service):
    ...
    def test_calculate_booking_amount_hourly(self, provider_service):
        ...
        amount = BookingService.calculate_booking_amount(
            provider_service=provider_service, duration_hours=3.0
        )
    ...
    def test_create_booking_unavailable_provider_fails(self, customer, provider, provider_service):
